...
struct Z_Construct_UEnum_OculusXRHMD_EOculusXRSupportedDevices_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "Quest3S.DisplayName", "Meta Quest 3S" },
		{ "Quest3S.Name", "EOculusXRSupportedDevices::Quest3S" },
...
struct Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bSupportSBC_MetaData[] = {
		{ "Category", "Mobile" },
		{ "Comment", "/** Whether Shader Binary Cache is enabled in app */" },
		{ "DisplayName", "Shader Binary Cache" },
		{ "ModuleRelativePath", "Public/OculusXRHMDRuntimeSettings.h" },
		{ "ToolTip", "Whether Shader Binary Cache is enabled in app" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_SBCPath_MetaData[] = {
		{ "Category", "Mobile" },
		{ "Comment", "/** Shader Binary Cache path used to save shader cache*/" },
		{ "DisplayName", "Shader Binary Cache Path" },
		{ "EditCondition", "bSupportSBC" },
		{ "ModuleRelativePath", "Public/OculusXRHMDRuntimeSettings.h" },
		{ "ToolTip", "Shader Binary Cache path used to save shader cache" },
	};
#endif // WITH_METADATA
	...
	static void NewProp_bThumbstickDpadEmulationEnabled_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bThumbstickDpadEmulationEnabled;
	...
	static void NewProp_bColocationSessionsEnabled_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bColocationSessionsEnabled;
	...
	static void NewProp_bFaceTrackingVisemesEnabled_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bFaceTrackingVisemesEnabled;
	...
	static void NewProp_bSupportSBC_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_bSupportSBC;
	static const UECodeGen_Private::FStrPropertyParams NewProp_SBCPath;
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bThumbstickDpadEmulationEnabled = { "bThumbstickDpadEmulationEnabled", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UOculusXRHMDRuntimeSettings), &Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bThumbstickDpadEmulationEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bThumbstickDpadEmulationEnabled_MetaData), NewProp_bThumbstickDpadEmulationEnabled_MetaData) };
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_PixelDensityMin = { "PixelDensityMin", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOculusXRHMDRuntimeSettings, PixelDensityMin), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PixelDensityMin_MetaData), NewProp_PixelDensityMin_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_PixelDensityMax = { "PixelDensityMax", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOculusXRHMDRuntimeSettings, PixelDensityMax), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PixelDensityMax_MetaData), NewProp_PixelDensityMax_MetaData) };
...
void Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bColocationSessionsEnabled_SetBit(void* Obj)
{
	((UOculusXRHMDRuntimeSettings*)Obj)->bColocationSessionsEnabled = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bColocationSessionsEnabled = { "bColocationSessionsEnabled", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UOculusXRHMDRuntimeSettings), &Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bColocationSessionsEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bColocationSessionsEnabled_MetaData), NewProp_bColocationSessionsEnabled_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bFaceTrackingVisemesEnabled = { "bFaceTrackingVisemesEnabled", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UOculusXRHMDRuntimeSettings), &Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bFaceTrackingVisemesEnabled_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bFaceTrackingVisemesEnabled_MetaData), NewProp_bFaceTrackingVisemesEnabled_MetaData) };
...
void Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bSupportSBC_SetBit(void* Obj)
{
	((UOculusXRHMDRuntimeSettings*)Obj)->bSupportSBC = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bSupportSBC = { "bSupportSBC", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UOculusXRHMDRuntimeSettings), &Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bSupportSBC_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bSupportSBC_MetaData), NewProp_bSupportSBC_MetaData) };
const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_SBCPath = { "SBCPath", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOculusXRHMDRuntimeSettings, SBCPath), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SBCPath_MetaData), NewProp_SBCPath_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bThumbstickDpadEmulationEnabled,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bColocationSessionsEnabled,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bFaceTrackingVisemesEnabled,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_bSupportSBC,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UOculusXRHMDRuntimeSettings_Statics::NewProp_SBCPath,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_OculusXRHMD_Public_OculusXRHMDRuntimeSettings_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UOculusXRHMDRuntimeSettings, UOculusXRHMDRuntimeSettings::StaticClass, TEXT("UOculusXRHMDRuntimeSettings"), &Z_Registration_Info_UClass_UOculusXRHMDRuntimeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusXRHMDRuntimeSettings), 1838805543U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_OculusXRHMD_Public_OculusXRHMDRuntimeSettings_h_566695094(TEXT("/Script/OculusXRHMD"),
	Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_OculusXRHMD_Public_OculusXRHMDRuntimeSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_OculusXRHMD_Public_OculusXRHMDRuntimeSettings_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_OculusXRHMD_Public_OculusXRHMDRuntimeSettings_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_OculusXRHMD_Public_OculusXRHMDRuntimeSettings_h_Statics::EnumInfo));
// End Registration
