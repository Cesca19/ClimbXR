...
struct Z_Construct_UEnum_OculusXRHMD_EOculusXRDeviceType_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "MetaQuest3S.Name", "EOculusXRDeviceType::MetaQuest3S" },
		{ "MetaQuest3SLink.Name", "EOculusXRDeviceType::MetaQuest3SLink" },
	...
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		...
		{ "EOculusXRDeviceType::MetaQuest3S", (int64)EOculusXRDeviceType::MetaQuest3S },
		...
		{ "EOculusXRDeviceType::MetaQuest3SLink", (int64)EOculusXRDeviceType::MetaQuest3SLink },
...
struct Z_Construct_UEnum_OculusXRHMD_EOculusXROcclusionsMode_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		...
		{ "HardOcclusions_Deprecated.Comment", "/// Hard occlusions, this is deprecated. Use soft occlusions instead.\n" },
		{ "HardOcclusions_Deprecated.Name", "EOculusXROcclusionsMode::HardOcclusions_Deprecated" },
		{ "HardOcclusions_Deprecated.ToolTip", "Hard occlusions, this is deprecated. Use soft occlusions instead." },
		{ "ModuleRelativePath", "Public/OculusXRHMDTypes.h" },
		{ "SoftOcclusions.Comment", "/// Soft occlusions, shows soft edges between the real and virtual world.\n" },
		{ "SoftOcclusions.Name", "EOculusXROcclusionsMode::SoftOcclusions" },
		{ "SoftOcclusions.ToolTip", "Soft occlusions, shows soft edges between the real and virtual world." },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EOculusXROcclusionsMode::Disabled", (int64)EOculusXROcclusionsMode::Disabled },
		{ "EOculusXROcclusionsMode::HardOcclusions_Deprecated", (int64)EOculusXROcclusionsMode::HardOcclusions_Deprecated },
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_OculusXRHMD_Public_OculusXRHMDTypes_h_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		...
		{ FOculusXRHmdUserProfile::StaticStruct, Z_Construct_UScriptStruct_FOculusXRHmdUserProfile_Statics::NewStructOps, TEXT("OculusXRHmdUserProfile"), &Z_Registration_Info_UScriptStruct_OculusXRHmdUserProfile, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOculusXRHmdUserProfile), 4171699205U) },
		...
		{ FOculusXRSplashDesc::StaticStruct, Z_Construct_UScriptStruct_FOculusXRSplashDesc_Statics::NewStructOps, TEXT("OculusXRSplashDesc"), &Z_Registration_Info_UScriptStruct_OculusXRSplashDesc, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOculusXRSplashDesc), 23528093U) },
		{ FOculusXRPerformanceMetrics::StaticStruct, Z_Construct_UScriptStruct_FOculusXRPerformanceMetrics_Statics::NewStructOps, TEXT("OculusXRPerformanceMetrics"), &Z_Registration_Info_UScriptStruct_OculusXRPerformanceMetrics, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOculusXRPerformanceMetrics), 543103634U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_OculusXRHMD_Public_OculusXRHMDTypes_h_4124326498(TEXT("/Script/OculusXRHMD"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_OculusXRHMD_Public_OculusXRHMDTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_OculusXRHMD_Public_OculusXRHMDTypes_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_OculusXRHMD_Public_OculusXRHMDTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_OculusXR_release_HostProject_Plugins_OculusXR_Source_OculusXRHMD_Public_OculusXRHMDTypes_h_Statics::EnumInfo));
// End Registration
